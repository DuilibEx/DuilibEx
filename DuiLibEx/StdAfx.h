...
#ifndef __FILET__
#define __DuiLibEx_STR2WSTR(str)	L##str
#define _DuiLibEx_STR2WSTR(str)	__DuiLibEx_STR2WSTR(str)
#ifdef _UNICODE
#define __FILET__	_DuiLibEx_STR2WSTR(__FILE__)
#define __FUNCTIONT__	_DuiLibEx_STR2WSTR(__FUNCTION__)
#else

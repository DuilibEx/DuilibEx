...
public:
    ...
    LRESULT HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
    {
        if( uMsg == WM_CREATE ) {
            ...
            CControlUI* pRoot = builder.Create( _T("DuilibExTestApp.xml"), (UINT)0, NULL, &m_pm);
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
    ...
    pFrame->Create(NULL, _T("这是一个最简单的测试用exe，修改DuilibExTestApp.xml就可以看到效果"), UI_WNDSTYLE_FRAME, WS_EX_WINDOWEDGE);
    pFrame->CenterWindow();
